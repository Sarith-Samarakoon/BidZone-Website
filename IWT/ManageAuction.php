...
<head>
    ...
    <script src="ManageAuction.js"></script>
    ...
    <header>
		...
		<div class="bar">
            <div class="headbtn">
                  ...
                  <a class="active" id="button" href= "ManageAuction.php">Manage Auction</a></li>
    ...
    <table border="2px" cellpadding="100px" cellspacing="10px">
        <tr>
            ...
            ?>
                ...
                <td><button id="btn3" type="button"><b>View Details</b></button></td>
                <td><button id="btn2" type="button" onclick="loadData()"><b>Approve</b></button></td>
                <td><button id="btn1" type="button" onclick="myFunction()"><b>Reject</b></button></td>
